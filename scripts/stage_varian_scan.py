#!/usr/bin/env python3
"""Symlink Clinical Varian SPARE participant + evaluation data into data/staged/."""
...
def stage_scan(
    ...
    evaluation = (
        spare_root / "Evaluation/ClinicalVarianDatasets" / f"P{pnum}" / scan_id
    )
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Stage Clinical Varian scan via symlinks")
    ap.add_argument("scan_ids", nargs="+", help="e.g. CV_P1_V_01 CV_P2_V_01")
